...
class Dataset(object):
    ...
    def random_scale(self, img, bboxes):
        ...
        img = canvas
        bboxes = self.clip_box(bboxes, [0, 0, 1 + img_shape[1], img_shape[0]], 0.25)

        return img, bboxes

    def random_shear(self, img, bboxes):
    ...
    def clip_box(bbox, clip_box, alpha):
        ...
        delta_area = ((ar_ - bbox.bbox_area(bbox)) / ar_)
    ...
    def parse_annotation(self, annotation):
        ...
        if self.data_aug:
            ...
            # image, bboxes = self.random_shear(np.copy(image), np.copy(bboxes))
